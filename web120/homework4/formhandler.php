...
$from='From: aandra03@seattlecentral.edu '. $email . "(" . $name . ")" . "\r\n"; 
...
$from='From:aandra03@seattlecentral.edu '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: aandra03@seattlecentral.edu' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from your WEBSITE'; // if your client has more than one web site, you can put the site name here.
...
mail ('aandra03@seattlecentral.edu', $subject, $body, $from);
